...
export const useOwnerStatusBadge = (ownerId, companyId) => {
  const { t } = useTranslation();
  const [badge, setBadge] = useState({ color: 'bg-muted text-muted-foreground', text: t('Checking...'), icon: 'loader', isOld: false });
