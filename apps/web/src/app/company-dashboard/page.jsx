...
import FollowUpCalendarWidget from '@/components/FollowUpCalendarWidget.jsx';
import ClientPipelineWidget from '@/components/ClientPipelineWidget.jsx';
import ClientsBySourceWidget from '@/components/ClientsBySourceWidget.jsx';
import { useCompanyAuth } from '@/contexts/CompanyAuthContext.jsx';
import pb from '@/lib/pocketbaseClient';
import { Building2, Home, Key, Users, Briefcase, Settings, ArrowRight } from 'lucide-react';
import { toast } from 'sonner';

const StatCard = ({ title, value, icon: Icon, loading, colorClass = "text-primary" }) => (
      ...
      try {
        ...
        try {
          ...
          if (currentUser.employeeId) {
            employeeRecord = await pb.collection('employees').getOne(currentUser.employeeId, { $autoCancel: false });
          } else {
