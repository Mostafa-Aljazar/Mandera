...
const PropertyCard = ({ property, onEdit, onView, onStatusChange }) => {
  ...
  const employeeName = property.expand?.employee_id?.name || property.expand?.employee_id?.email || t('Unassigned');
