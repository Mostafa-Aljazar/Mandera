...
interface BulkAssignModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: (data: { employeeId: string; statusId: string | null }) => Promise<void>;
  employees?: BulkAssignEmployee[];
  statuses?: BulkAssignStatus[];
  selectedCount?: number;
}

export default function BulkAssignModal({ isOpen, onClose, onConfirm, employees = [], statuses = [], selectedCount = 0 }: BulkAssignModalProps) {
