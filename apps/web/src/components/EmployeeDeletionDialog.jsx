...
import { useEmployeeDeletion } from '@/hooks/useEmployeeDeletion.js';
import { useCompanyAuth } from '@/contexts/CompanyAuthContext.jsx';
import pb from '@/lib/pocketbaseClient';

const EmployeeDeletionDialog = ({ isOpen, onClose, employeeToDelete, onSuccess, companyId: propCompanyId }) => {
