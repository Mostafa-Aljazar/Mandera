...
migrate((app) => {
  ...
  const property_typesCollection = app.findCollectionByNameOrId("property_types");
  ...
  const collection = new Collection({
    ...
    "fields":     [
          ...
          },
          {
                ...
                "type": "relation",
                "cascadeDelete": false,
                "collectionId": property_typesCollection.id,
                "displayFields": [],
                "maxSelect": 1,
                "minSelect": 0
          },
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_3656272165");
