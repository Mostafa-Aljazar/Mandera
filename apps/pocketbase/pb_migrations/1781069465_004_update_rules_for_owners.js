...
migrate((app) => {
  ...
  collection.listRule = "@request.auth.companyId = company_id && (assigned_employee_id = @request.auth.id || @request.auth.role = 'company_super_admin')";
  collection.viewRule = "@request.auth.companyId = company_id";
  collection.updateRule = "@request.auth.companyId = company_id && (assigned_employee_id = @request.auth.id || @request.auth.role = 'company_super_admin')";
