...
export default function MasterAdminHeader() {
  ...
  const navItems = [
    ...
    },
    {
      ...
      label: t("master_nav_settings"),
      icon: Settings,
      match: (path: string) => path.startsWith("/master/dashboard/settings"),
    },
  ];
            ...
            {navItems.map(({ href, label, icon: Icon, match }) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="max-w-[9rem] lg:max-w-none truncate">
                    {label}
                  </span>
                </Link>
              );
