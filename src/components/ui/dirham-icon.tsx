...
/**
 * Official UAE Dirham currency symbol (CBUAE).
 * Path from the Central Bank vector asset (viewBox 1000×870).
 * Uses currentColor so it inherits text/icon color.
 *
...
export function DirhamIcon({
  ...
  className?: string;
  /** Override screen-reader / tooltip label. Defaults to t("AED"). */
  title?: string;
